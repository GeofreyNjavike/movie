...
@section('content')
    ...
    <div class="flex flex-wrap">
        <div class="w-full md:bg-contain  h-96  bg-center"
            style="background-image:url(https://image.tmdb.org/t/p/original/.{{ $results['backdrop_path'] }});">
            <div class="flex items-center justify-center w-full h-full bg-gray-900 bg-opacity-30">
                <div class="text-center">
                    <h1 class="text-5xl font-semibold text-white uppercase lg:text-3xl">
                        <strong> {{ $results['original_title'] }}</strong>
                    </h1>
    ...
    <div class="border-8 border-white-500 rounded-full bg-white shadow flex w-full">
        <form action="{{ route('search') }}" method="POST">
            @csrf
            @method('GET')
            <input type="text" placeholder="Enter the Movies name" name="results"
            ...
            <div class="flex justify-center px-6 my-12">
                ...
                <div class="w-full xl:w-11/12 lg:w-3/4 flex">
                    ...
                    <div class="w-full h-auto bg-gray-400 lg:block lg:w-1/2 bg-cover rounded-l-lg"
                        style="background-image: url('https://image.tmdb.org/t/p/original/.{{ $results['poster_path'] }}')">
                    </div>
                    <!-- Col -->
                    <div class="w-full lg:w-1/2 bg-white p-5 rounded-lg lg:rounded-l-none">
                        <div class="px-8 mb-4 text-center">
                            ...
                            <h3 class="font-black text-lg">{{ $results['original_title'] }}</h3>
                            {{ $results['overview'] }}
                            </p>
                        ...
                        <div class="py-10 px-6 text-center tracking-wide grid grid-cols-3 gap-6">
                            ...
                            <div class="followers">
                                <p class="text-xs">{{ $results['vote_average'] }}</p>
                                <p class="text-yellow-400 text-xs"><span>
                                        @if ($results['vote_average'] <= 3)
                                        ...
                                        @elseif ($results['vote_average'] >=3 and $results['vote_average'] <=7) <div
                            ...
                            <div class="following">
                                <p class="text-xs">{{ $results['release_date'] }}</p>
